            ...
            >
              ...
              <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    fullWidth
                    label="Currency Price Surge Debit %"
                    name="currencyPriceSurgeDebit"
                    type="number"
                    value={formik.values.currencyPriceSurgeDebit}
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    error={
                      formik.touched.currencyPriceSurgeDebit &&
                      Boolean(formik.errors.currencyPriceSurgeDebit)
                    }
                    helperText={
                      formik.touched.currencyPriceSurgeDebit &&
                      formik.errors.currencyPriceSurgeDebit
                    }
                    disabled={isView}
                    size="small"
                    sx={{
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    fullWidth
                    label="Minimum Recharge Allowed Amount"
                    name="minRechargeAllowedAmount"
                    type="number"
                    value={formik.values.minRechargeAllowedAmount}
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    error={
                      formik.touched.minRechargeAllowedAmount &&
                      Boolean(formik.errors.minRechargeAllowedAmount)
                    }
                    helperText={
                      formik.touched.minRechargeAllowedAmount &&
                      formik.errors.minRechargeAllowedAmount
                    }
                    disabled={isView}
                    size="small"
                    sx={{
