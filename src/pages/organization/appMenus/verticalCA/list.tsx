...
export default function HorizontalCAList() {
  ...
  const fetchData = () => {
    setLoading(true);
    fetch(
      `${process.env.REACT_APP_API_BASE_URL}/menu/?menuType=vertical&appType=ca&Status=true`
    )
      .then((res) => {
  ...
  return (
    <>
      ...
      >
        ...
        <IconButton
          color="primary"
          onClick={() => navigate("/organization/appMenus/verticalCA/add")}
          sx={{ background: "#f5f6fa", boxShadow: 1 }}
        >
          <AddIcon />
        </IconButton>
      </Box>
                  ...
                  <TableRow key={row._id}>
                    ...
                    <TableCell>
                      ...
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/organization/appMenus/verticalCA/edit/${row._id}`
                          )
                        }
                      >
                        <EditIcon />
                      ...
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/organization/appMenus/verticalCA/view/${row._id}`
                          )
                        }
                      >
                        <VisibilityIcon />
