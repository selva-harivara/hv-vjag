...
export default function HorizontalCAList() {
  ...
  const fetchData = () => {
    setLoading(true);
    fetch(
      `${process.env.REACT_APP_API_BASE_URL}/menu/?menuType=vertical&appType=va&Status=true`
    )
      .then((res) => {
  ...
  return (
    <>
      ...
      >
        ...
        <IconButton
          color="primary"
          onClick={() => navigate("/organization/appMenus/verticalVA/add")}
                  ...
                  <TableRow key={row._id}>
                    ...
                    <TableCell>
                      ...
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/organization/appMenus/verticalVA/edit/${row._id}`
                          )
                        }
                      >
                        <EditIcon />
                      ...
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/organization/appMenus/verticalVA/view/${row._id}`
                          )
                        }
                      >
                        <VisibilityIcon />
